        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl font-extrabold sm:text-6xl md:text-7xl" style={{ color: '#1F2937' }}>
              ...
              <span className="block" style={{ color: '#1D4ED8' }}>When It Matters Most</span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl" style={{ color: '#6B7280' }}>
              When your family needs help, we're here. Get trusted guidance on the resources available to you — fast, free, and compassionate.
            </p>
